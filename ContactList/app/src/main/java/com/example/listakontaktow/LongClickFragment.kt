...
class LongClickFragment : DialogFragment() {

    lateinit var mListener: LongClickDialogInteractionListener

    private var contactNameParam: String? = null
    private var contactPosParam: Int? = null

    interface LongClickDialogInteractionListener{
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setMessage("Do you want to call to" + " $contactNameParam" + "?")
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(name: String, pos: Int, interactionListener: LongClickDialogInteractionListener) =
            LongClickFragment().apply {
