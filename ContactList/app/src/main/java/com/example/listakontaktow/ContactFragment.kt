...
import com.example.listakontaktow.databinding.FragmentItemListBinding
...
class ContactFragment : Fragment(), MyContactListListener, LongClickFragment.LongClickDialogInteractionListener {
    ...
    override fun onCreateView(
        ...
        with(binding.list)
        {
            ...
            adapter = MyContactRecyclerViewAdapter(activity, Contacts.ITEMS, this@ContactFragment)
        }
