package com.example.lab2poprawione
...
import com.example.lab2.SettingsActivity
...
class MainActivity : AppCompatActivity(), View.OnClickListener, View.OnLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinner: Spinner = findViewById(R.id.spinnner)
    ...
    val resultTextView = findViewById<TextView>(R.id.resultTxtViev)
    ...
    private fun shareResult() {
        ...
        shareIntent.setType("text/playin")
    ...
    private val launchSettingsActivity = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){ result ->
        if(result.resultCode == RESULT_OK){
            format = result.data?.getStringExtra(getString(R.string.numberFormat)) ?: "Flaot"
