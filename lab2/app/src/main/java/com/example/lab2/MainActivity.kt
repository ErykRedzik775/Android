...
class MainActivity : AppCompatActivity(), View.OnClickListener, View.OnLongClickListener {
    ...
    private fun clearCalculator() {
        ...
        Snackbar.make(
            ...
            getString(R.id.clear_msg),
            Snackbar.LENGTH_SHORT
        ).show()
    }

    fun selectOperation(view: android.view.View) {
    ...
    private fun startSettingsActivity() {
        val intet: Intent = Intent(this,SettingsActivity::class.java)
    ...
    private val launchSettingsActivity = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){ result ->
        if(result.resultCode == RESULT_OK){
            format = result.data?.getStringExtra(getString(R.string.numberFormatKey)) ?: "Flaot"
